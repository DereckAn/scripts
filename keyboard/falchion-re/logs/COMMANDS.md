...
| `74-candidate-integrity-crc-analysis.txt` | `python3 tool/analyze_candidate_integrity.py` | Decoded the SN_FWIN 4-word record table, reproduced Candidate A's IEEE CRC-32 exactly, and showed Candidate B's `0x1a76c116` matches no CRC-32 interpretation/range of the container's B bytes; bootloader uses the reflected `0xedb88320` CRC-32 |
