...
The safest high-value continuation is decoding the complete Candidate B
layout/profile map at `0x1801c37c` and relating it to the recovered translation
table, key records, and wire target field. This can further clarify target
encoding without touching the keyboard.
