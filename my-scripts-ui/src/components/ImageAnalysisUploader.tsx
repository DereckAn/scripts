...
import { ImageFile } from '@/types/image-analysis';
import { createImageFile, validateImageFile } from '@/utils/image-analysis';
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-stone-500 dark:text-stone-500 mb-4">
              Soporta: JPEG, PNG, WebP, BMP, TIFF (máximo {maxFiles} archivos, 50MB cada uno)
            </p>
          </div>
          ...
          <label className="inline-block">
            <input
              ...
              className="hidden"
            />
            <span className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 cursor-pointer inline-block">
